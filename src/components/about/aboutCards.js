...
const AboutCards = () => {
    return (
        <div className="grid grid-cols-1">
            <div className="grid grid-cols-12 my-10 lg:h-72 sm:shadow-md sm:bg-white vl:bg-transparent mb-5 flex vl:flex-col sm:flex-row">
                <div className="col-span-4 h-72 putVideoPicMap">
                ...
                <div className="col-span-8 lg:px-14 lg:py-8 vl:p-3  ">
                    <h1 className="text-xl text-blue-500 font-semibold lg:mb-5 md:mb-3 uppercase">
                        Yuksak Idrok
                    </h1>
                    <p>
            ...
            <div className="grid grid-cols-12 my-10 lg:h-72 sm:shadow-md sm:bg-white vl:bg-transparent mb-5 flex vl:flex-col sm:flex-row">
                ...
                <div className="col-span-8 w-full lg:px-14 lg:py-8 vl:p-3 ">
                    <h1 className="text-xl text-blue-500 font-semibold uppercase lg:mb-5 md:mb-3">
                        Yuksak Idrok
                    </h1>
                    <p>
                        2020 - yil 1-oktabr oyi YUKSAK IDROK O’quv Markaziga asos solingan kun. Dastlab markazimiz o'z
