...
const AboutCards = () => {
    return (
        <div className="grid grid-cols-1">
            <div className="my-10 w-full lg:h-72 shadow-md bg-white mb-5 flex  md:flex-row">
                <div className="md:w-1/3 sm:w-full h-full putVideoPicMap">
                ...
                <div className="w-full lg:px-14 lg:py-8 sm:px-3 sm:py-3">
