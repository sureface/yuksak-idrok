...
const AboutCards = () => {
    return (
        <div className="grid grid-cols-1">
            <div className="my-10 w-full lg:h-72 sm:shadow-md sm:bg-white vl:bg-transparent mb-5 flex vl:flex-col sm:flex-row">
                <div className="md:w-1/3 vl:w-full h-72 putVideoPicMap">
                ...
                <div className="w-full lg:px-14 lg:py-8 vl:p-3  ">
                    <h1 className="text-xl  font-semibold lg:mb-5 md:mb-3">
                        Yuksak Idrok
                    </h1>
                    <p>
            ...
            <div className="my-10 w-full lg:h-72 sm:shadow-md sm:bg-white vl:bg-transparent mb-5 flex   vl:flex-col sm:flex-row">
                <div className="md:w-1/3 sm:w-full h-full youtubeVideo">
                    <img
