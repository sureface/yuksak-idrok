            ...
            <div className="container mx-auto">
                ...
                <form className="flex flex-col">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        <input className="py-3 px-5 rounded-xl" type="text" placeholder="Your Name" name="name" id="name" />
                    ...
                    <div className="grid grid-cols-1 gap-4 mb-4">
                        <textarea className="py-3 px-5 rounded-xl" name="textarea" placeholder="Savolingiz..?" id="textarea" cols="30" rows="10"> </textarea>
                    </div>
